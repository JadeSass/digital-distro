...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="row" style="background: rgba(251,251,251,0);">
            <div class="contar">
               <iframe src="https://www.youtube.com/embed/w60X5izsEzM?modestbranding=1 frameborder="0" loop=1 allow="accelerometer; autoplay; clipboard-write; rel=0 encrypted-media; gyroscope; picture-in-picture" allowfullscreen ></iframe>
            <div>
